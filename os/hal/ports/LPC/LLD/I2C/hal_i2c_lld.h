 ...
 */
#if !defined(LPC_I2C_I2C1_PRIORITY) || defined(__DOXYGEN__)
#define LPC_I2C_I2C1_PRIORITY        12
#endif

/**
 * @brief   Timeout for external clearing BUSY bus (in ms).
 */
#if !defined(LPC_I2C_BUSY_TIMEOUT) || defined(__DOXYGEN__)
#define LPC_I2C_BUSY_TIMEOUT         50
#endif
...
/** @brief  error checks */
#if LPC_I2C_USE_I2C1 && !LPC_HAS_I2C1
